# HA-BUILD.md — Making Things

Read this when the request is to *create* or *change* something: an automation,
a script, a scene, a helper, a dashboard, or a YAML file. For reading state and
turning things on and off, `ha help` is enough — see `HA.md` if something is
broken.
